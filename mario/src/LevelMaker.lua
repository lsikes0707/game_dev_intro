...
function LevelMaker.generate(width, height)
    ...
    for x = 1, width do
        ...
        -- chance to just be emptiness but never the first column
        if x ~= 1 and math.random(7) == 1 then
            ...
            -- chance to spawn a locked block, increasing as we progress through level generation
