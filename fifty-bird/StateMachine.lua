--[[
    ...
    -- States are only creted as needed, to save memory, reduce clean-up bugs and increase speed
    ...
    reason not to. i.e. MainMenu creates a state using the MaineMenu table. This keeps things
    straight forward.
