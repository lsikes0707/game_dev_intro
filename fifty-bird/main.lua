...
function love.load()
    ...
    -- initialize state machine with all state0returning functions
...
--[[
    LOVE2D callback fired each time a mouse button is pressed; gives us the
...
function love.update(dt)
    ...
    love.mouse.buttonsPressed = {}  -- reset mouse input table
end
