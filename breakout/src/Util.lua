...
--[[
    ...
    width and a height for the tiles therin, split the textures into
...
--[[
    Utility function for slicing tbales, a la Python.
...
--[[
    ...
    maniually, since they are all different sizes.
]]
